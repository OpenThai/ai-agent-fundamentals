...
6. **Continue** — LLM ใช้ผลลัพธ์เพื่อ思考或ตัดสินใจขั้นต่อไป
...
- **Error Handling** — ถ้าเครื่องมือ error ต้องบอก Agent ให้ลองใหม่或用其他方法
...
LLM แค่ **ขอ** เรียก function — ระบบภายนอก (Runtime) ต่างหากที่เป็นคน执行และส่งผลกลับ
